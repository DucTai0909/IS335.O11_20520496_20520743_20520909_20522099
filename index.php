...
<head>	
    ...
    <link rel="stylesheet" style="style/sheet" href="css/comment.css">
	<link rel="icon" href="img/lego1.png" type="image/x-icon">
	<link rel="shortcut icon" href="img/lego1.png" type="image/x-icon">
	...
	<div id= "footer">
		<div id="footer1">
		  <div class="box"> 
		    ...
		    <h3 class="slogan">Sách -Tri thức của nhân loại!</h3>
		  </div>
			<div class="box1">
				<div id = "box_footer1">
					<ul>
		  ...
		  <div class="box3">
			...
			<p><b>Địa chỉ:</b>Khu phố 6,phường Linh Trung, quận Thủ Đức </p>
				...
				<p><b>Email:</b> 18520824@gm.uit.edu.vn</p>
		  </div>
		  
		  <div class="box1">
		  <br><br>
			  <a href="https://www.facebook.com/giahuy.giaha/"><img src= "./img/icon/facebook.png" width="20%" >  </a>
			  <a href="https://www.instagram.com/giahagiahuy/"><img src= "./img/icon/instagram.png" width="20%" ></a>
		  </div>
	  </div>
